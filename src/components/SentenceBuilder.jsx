...
const SentencePractice = () => {
    ...
    return (
        <>
            <section className='px-8 md:px-16 lg:px-20'>
                <div className="mt-8 relative overflow-hidden p-6 md:p-8 rounded-[24px] md:rounded-[32px] bg-white border border-slate-200 shadow-xl text-left">
                    ...
                    <div className={`min-h-[110px] p-5 mb-5 rounded-2xl border-2 transition-all duration-300 flex flex-wrap gap-2 items-center justify-center ${status === 'checked' && isCorrect ? 'bg-green-50 border-green-200' :
